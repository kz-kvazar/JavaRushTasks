...
public class Game {
    private final List<Sportsman> members;
    ...
    public void startCompetition() {
        for (int i = 0; i < members.size(); i++) {
            ...
            BigDecimal timeToRace = controlSportsman.getResultTime().subtract(BigDecimal.valueOf((long) members.get(i).getCountHitOutTarget() * PENALTY_TIME_PER_ONE_MISS));
            members.get(i).setAverageSpeed(new BigDecimal(RACE_LENGTH / (timeToRace.doubleValue() / 3600)).setScale(4, RoundingMode.HALF_UP));
